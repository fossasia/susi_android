...
class ConnectedDevicesAdapter(private val connectedDevicesList: ArrayList<Device>, val connectedDevicePresenter: IConnectedDevicePresenter) : androidx.recyclerview.widget.RecyclerView.Adapter<ConnectedDevicesAdapter.ViewHolder>() {
