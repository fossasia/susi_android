 ...
 */
class AlertboxHelper (private val activity: Activity, private val title: String?, private val message: String?,
                      private val dialogPositiveClick: DialogInterface.OnClickListener?,
                      private val dialogNegativeClick: DialogInterface.OnClickListener?, private val positiveText: String?,
                      private val negativeText: String?, private val colour: Int) {
