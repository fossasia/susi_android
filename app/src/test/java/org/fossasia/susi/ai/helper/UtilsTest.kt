...
class UtilsTest {
    ...
    fun verifyImageLink() {
        ...
        assertEquals("https://api.susi.ai/cms/getImage.png?model=model&language=test&group=abc%20def%20ghi&image=images/test_image.jpg",
                Utils.getImageLink(SkillData(model = "model", group = "abc def ghi", language = "test", image = "images/test_image.jpg")))
